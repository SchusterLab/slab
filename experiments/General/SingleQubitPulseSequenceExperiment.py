...
class VacuumRabiExperiment(QubitPulseSequenceExperiment):
    def __init__(self, path='', prefix='VacuumRabi', config_file='..\\config.json', **kwargs):
        QubitPulseSequenceExperiment.__init__(self, path=path, prefix='Vacuum_Rabi', config_file=config_file,
                                              PulseSequence=VacuumRabiSequence, pre_run=self.pre_run,
...
class PulseProbeExperiment(QubitPulseSequenceExperiment):
    def __init__(self, path='', prefix='PulseProbe', config_file='..\\config.json', **kwargs):
        QubitPulseSequenceExperiment.__init__(self, path=path, prefix='Pulse_Probe', config_file=config_file,
                                              PulseSequence=PulseProbeSequence, pre_run=self.pre_run,
                                              post_run=self.post_run, **kwargs)
