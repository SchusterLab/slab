...
def run_experiment(expt_name,lp_enable = True,config_file='..\\config.json', **kwargs):
    ...
    if expt_name.lower() == 'blue_sideband_rabi':
        from slab.experiments.General.SingleQubitPulseSequenceExperiment import BlueSidebandRabiExperiment
        # Do CW drive experiment
    ...
    if expt_name.lower() == 'qp_pumping':
        from slab.experiments.General.SingleQubitPulseSequenceExperiment import QPPumpingExperiment
        # Do Vacuum Rabi
