...
"""
from configuration_IQ import config, ge_IF, qubit_freq, two_chi, disc_file_opt, st_self_kerr, storage_IF, storage_cal_file, opt_len, two_chi_2, disc_file
from qm.qua import *
...
import json
analysis_params = { 'qubit_params': {'t1':71, 't2':150, 'nth':3e-2},
                    'cavity_params' : {'t1':1.412e3, 'nth':0.0006},
                    'readout_params':{'length':3.3, 'trigger':7.356, 'pi_pulse':3, 'g_inf':0.036, 'e_inf':0.0495},
                    }
