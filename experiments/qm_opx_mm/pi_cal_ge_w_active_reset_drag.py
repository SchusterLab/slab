...
from configuration_IQ import config, biased_th_g, disc_file_opt, pi_amp_drag, half_pi_amp_drag
from qm.qua import *
...
n_pi_pulses = 12
a_pi_min= 0.95*pi_amp_drag
a_pi_max = 1.05*pi_amp_drag

n_pi_2_pulses = 24
a_pi_2_min= 0.95*half_pi_amp_drag
a_pi_2_max = 1.05*half_pi_amp_drag
...
seq_data_file = os.path.join(data_path,
                             get_next_filename(data_path, 'power_rabi_drag', suffix='.h5'))
print(seq_data_file)
