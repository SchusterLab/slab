from configuration_IQ import config, ge_IF, qubit_freq, disc_file_opt, two_chi
from qm.qua import *
...
for cav_len in pulse_len[:1]:

    t_chi = int(0.5*1e9/two_chi[1]) #qubit rotates by pi in this time
    cav_len = cav_len
    cav_amp = 0.1 # 0.08
