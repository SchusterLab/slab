    ...
    with program() as exp:
        ...
        with for_(n, 0, n < avgs, n + 1):
            ...
            with if_(bit_sum==0):
                ...
                play('gaussian'*amp(coh_amp), 'storage_mode1', duration=coh_len)
                align('rr', 'qubit_mode0', 'storage_mode1')
...
import json
analysis_params = { 'qubit_params': {'t1':121, 't2':229, 'nth':3e-2},
                    'cavity_params' : {'t1':1.313e3, 'nth':0.0006},
                    'readout_params':{'length':2.2, 'trigger':7.356, 'pi_pulse':3, 'g_inf':0.0536, 'e_inf':0.0482},
                    }

# path = os.getcwd()
data_path = 'S:\\_Data\\20220222 - 3DMM - StimEm - OPX\\data\\stim_em_snap_rp_n+1\\20220227\\'
...
for kk in range(2):
    ...
    for ii in range(len(camp)):
        ...
        for f_num in range(5):
            ...
            filename = "stim_em_n" + str(fock_number) +"_gauss_camp_" + str(coh_amp)+"_len_"+str(l)
