...
num_pi_pulses_m = 10 #need even number to bring the qubit back to 'g' before coherent drive0
num_pi_pulses_n = 0
...
with program() as binary_decomposition:
    ...
    with stream_processing():
        num1_st.buffer(num_pi_pulses_m+num_pi_pulses_n).save_all('num1')
...
if simulation:
    ...
    seq_data_file = os.path.join(data_path,
                                 get_next_filename(data_path, 'stim_em_bd_rep_bd_debug', suffix='.h5'))
    print(seq_data_file)
