...
class StateDiscriminator:
    ...
    def train(self, program, use_hann_filter=True, plot=False, correction_method='robust', **execute_args):
        ...
        traces = self._get_traces(self.rr_qe, correction_method, I_res, Q_res, seq0, sig, use_hann_filter)
    ...
    def measure_state(self, pulse, out1, out2, res, adc=None):
        ...
        measure(pulse, self.rr_qe, adc, demod.full('state_0_in1', d1_st0, out1),
