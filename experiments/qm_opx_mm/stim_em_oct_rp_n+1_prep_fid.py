    ...
    with program() as exp:
        ...
        with for_(n, 0, n < avgs, n + 1):
            ...
            with for_(i, 0, i < n_pi_m, i+1):
                ...
                wait(250, "rr")
            #########################
            update_frequency('qubit_mode0', ge_IF[0] + (fstate_cal)*two_chi[1]+ (fstate_cal)*(fstate_cal-1)*two_chi_2)
...
data_path = data_path = 'S:\\_Data\\20220222 - 3DMM - StimEm - OPX\\data\\stim_em_snap_rp_n+1\\20220224\\state_prep_fid_oct_matrix.json'
...
for f_num in range(7):
    ...
    for n in (n_list):
        ...
        print(len(Q), np.mean(Q), np.std(Q))
