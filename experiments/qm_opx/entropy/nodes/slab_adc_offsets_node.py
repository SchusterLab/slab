...
class AdcOffsetsNode(QuaCalNode):
    ...
    def run_program(self, config, context: EntropyContext):
        ...
        qpu_db.set('readout', 'con1'['adc1_offset'], config['controllers']['con1']['analog_inputs'][1]['offset']-adcI_offset)
        qpu_db.set('readout', 'con1'['adc2_offset'], config['controllers']['con1']['analog_inputs'][2]['offset']-adcQ_offset)
        qpu_db.commit()
    ...
    def update_config(self, config: QuaConfig, context: EntropyContext) -> QuaConfig:
        ...
        config['controllers']['con1']['analog_inputs'][1]['offset'] = qpu_db.get('readout', 'con1').value['adc1_offset']
        config['controllers']['con1']['analog_inputs'][2]['offset'] = qpu_db.get('readout', 'con1').value['adc2_offset']
        return config
