from configuration_IQ import config, pump_IF, long_redout_len
from qm.qua import *
...
with program() as histogram:
    ...
    with for_(f, pump_IF + f_min, f <= pump_IF + f_max , f + df):
...
if simulation:
    ...
    seq_data_file = os.path.join(data_path,
                                 get_next_filename(data_path, 'histogram_jpa_freq_sweep', suffix='.h5'))
    print(seq_data_file)
