...
qubit_ef_freq = 4.60868465229553e9

ge_IF = 100e6 # g-e IF
ef_IF = (qubit_freq-qubit_ef_freq) + ge_IF# e-f IF
...
with program() as histogram:
    ...
    with for_(n, 0, n < avgs, n + 1):
        ...
        play("pi", "qubit", duration=0)
        align("qubit", "rr")
        measure("long_readout", "rr", None, demod.full("long_integW1", Ig, 'out1'),demod.full("long_integW1", Qg, 'out2'))
        save(Ig, Ig_st)
        save(Qg, Qg_st)
        ...
        play("pi", "qubit")
        align("qubit", "rr")
        measure("long_readout", "rr", None, demod.full("long_integW1", Ie, 'out1'), demod.full("long_integW1", Qe, 'out2'))
        save(Ie, Ie_st)
        save(Qe, Qe_st)
