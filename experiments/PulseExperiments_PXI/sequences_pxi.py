...
class PulseSequences:
    ...
    def readout_pxi(self, sequencer, on_qubits=None, sideband = False, overlap = False):
        ...
        for qb_id in on_qubits:
            sequencer.append('readout%s'%qb_id,
                             Square(max_amp=self.quantum_device_cfg['readout'][qb_id]['amp'],
                                    flat_len=self.quantum_device_cfg['readout'][qb_id]['length'],
