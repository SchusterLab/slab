...
#DM Comments:
#'wfLib' is a dictionary of waveforms
#'linkList' is a "n" length list of entry structure lists
#entry.key specifies the element of 'wfLib' for that particular sequence waveform
def write_Tek_file(awgData, fileName, seqName, options=None, do_string_IO=False):

    #do string IO is for testing    
