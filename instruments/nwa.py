...
class E5071(SocketInstrument):
    ...
    def __init__(self, name="E5071", address=None, enabled=True):
        SocketInstrument.__init__(self, name, address, enabled=enabled, timeout=10000, recv_length=2 ** 20)
...
class E5071_USB(VisaInstrument):
    MAXSWEEPPTS = 1601
    default_port = 5025

    def __init__(self, name="E5071", address='USB0::0x0957::0x0D09::MY46110978::0::INSTR', enabled=True, timeout=None):
