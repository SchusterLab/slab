...
def get_singleshot_data_two_qubits_4_calibration_single_cavity(single_data_list):
    ...
    for qubit_1_state in qubit_state:
        for qubit_2_state in qubit_state:
            ...
            X_state = np.array([qubit_1_ss_cos,qubit_1_ss_sin])
...
#     print(state_norm[-9:,:])
    ...
    return state_norm, confusion_matrix
