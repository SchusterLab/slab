...
class Experiment:
    ...
    def initiate_flux(self):
        if self.quantum_device_cfg['freq_flux']['calibrated']:
            ...
            print('Flux1: ', (self.quantum_device_cfg['freq_flux']['1']['current_mA'] + 0.0865365 * self.quantum_device_cfg['freq_flux']['2']['current_mA']- 0.132))
            print('Flux2: ', (self.quantum_device_cfg['freq_flux']['2']['current_mA'] + 0.3521470 * self.quantum_device_cfg['freq_flux']['1']['current_mA']+ 0.440))
            self.flux1.ramp_current((self.quantum_device_cfg['freq_flux']['1']['current_mA'] + 0.0865365 * self.quantum_device_cfg['freq_flux']['2']['current_mA'] - 0.132)* 1e-3)
            self.flux2.ramp_current((self.quantum_device_cfg['freq_flux']['2']['current_mA'] + 0.3521470 * self.quantum_device_cfg['freq_flux']['1']['current_mA'] + 0.440) * 1e-3)
        else:
