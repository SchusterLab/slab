...
class SignalCore(Instrument):
    ...
    def send_soft_trigger(self, acknowledge = True):
    ...
    def set_list_mode(self, sss_mode=1, sweep_dir=0, tri_waveform=0, hw_trigger=0, step_on_hw_trig=0,
        ...
        """ Configures list mode
            ...
            trig_out_enable = 0: No output trigger, 1: Output trigger enabled on trigger pin (#20)
    ...
    def get_device_status(self):
        """ Obtaines device status using the structure
        """
        ds = DeviceStatus()
