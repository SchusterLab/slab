...
class Ui_SpectrumAnalyzerWindow(object):
    def setupUi(self, SpectrumAnalyzerWindow):
        ...
        self.frequencySpinBox.setProperty(_fromUtf8("value"), 4.99)
        ...
        self.startSweepSpinBox.setSingleStep(0.01)
        self.startSweepSpinBox.setProperty(_fromUtf8("value"), 4.7)
        ...
        self.endSweepSpinBox.setSingleStep(0.01)
        self.endSweepSpinBox.setProperty(_fromUtf8("value"), 5.1)
