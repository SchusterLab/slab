...
class Ui_ScopeWindow(object):
    def setupUi(self, ScopeWindow):
        ...
        self.SampleSettings.setObjectName("SampleSettings")
        ...
        self.recordsSpinBox.setObjectName("recordsSpinBox")
        ...
        self.Ch1Vertical.setObjectName("Ch1Vertical")
        ...
        self.ch1_enabledCheckBox.setObjectName("ch1_enabledCheckBox")
        ...
        self.ch1_filteredCheckBox.setObjectName("ch1_filteredCheckBox")
        ...
        self.ch1_rangeComboBox.setObjectName("ch1_rangeComboBox")
        self.ch1_rangeComboBox.addItem(QtCore.QString())
        self.ch1_rangeComboBox.addItem(QtCore.QString())
        self.ch1_rangeComboBox.addItem(QtCore.QString())
        self.ch1_rangeComboBox.addItem(QtCore.QString())
        self.ch1_rangeComboBox.addItem(QtCore.QString())
        ...
        self.ch1_couplingComboBox.setObjectName("ch1_couplingComboBox")
        self.ch1_couplingComboBox.addItem(QtCore.QString())
        self.ch1_couplingComboBox.addItem(QtCore.QString())
        ...
        self.Ch2Vertical.setObjectName("Ch2Vertical")
        ...
        self.ch2_enabledCheckBox.setObjectName("ch2_enabledCheckBox")
        ...
        self.ch2_filteredCheckBox.setObjectName("ch2_filteredCheckBox")
        ...
        self.ch2_rangeComboBox.setObjectName("ch2_rangeComboBox")
        self.ch2_rangeComboBox.addItem(QtCore.QString())
        self.ch2_rangeComboBox.addItem(QtCore.QString())
        self.ch2_rangeComboBox.addItem(QtCore.QString())
        self.ch2_rangeComboBox.addItem(QtCore.QString())
        self.ch2_rangeComboBox.addItem(QtCore.QString())
        ...
        self.ch2_couplingComboBox.setObjectName("ch2_couplingComboBox")
        self.ch2_couplingComboBox.addItem(QtCore.QString())
        self.ch2_couplingComboBox.addItem(QtCore.QString())
        ...
        self.ClockSettings.setObjectName("ClockSettings")
        ...
        self.samplerateComboBox.addItem(QtCore.QString())
        self.samplerateComboBox.addItem(QtCore.QString())
        self.samplerateComboBox.addItem(QtCore.QString())
        self.samplerateComboBox.addItem(QtCore.QString())
        self.samplerateComboBox.addItem(QtCore.QString())
        ...
        self.clocksourceComboBox.setObjectName("clocksourceComboBox")
        self.clocksourceComboBox.addItem(QtCore.QString())
        self.clocksourceComboBox.addItem(QtCore.QString())
        self.clocksourceComboBox.addItem(QtCore.QString())
        self.clocksourceComboBox.addItem(QtCore.QString())
        ...
        self.clockedgeComboBox.setObjectName("clockedgeComboBox")
        self.clockedgeComboBox.addItem(QtCore.QString())
        self.clockedgeComboBox.addItem(QtCore.QString())
        ...
        self.timeoutSpinBox.setProperty("value", QtCore.QVariant(5000))
        ...
        self.TriggerSettings.setObjectName("TriggerSettings")
        ...
        self.trig1_sourceComboBox.setObjectName("trig1_sourceComboBox")
        self.trig1_sourceComboBox.addItem(QtCore.QString())
        self.trig1_sourceComboBox.addItem(QtCore.QString())
        self.trig1_sourceComboBox.addItem(QtCore.QString())
        self.trig1_sourceComboBox.addItem(QtCore.QString())
        ...
        self.trig1_edgeComboBox.setObjectName("trig1_edgeComboBox")
        self.trig1_edgeComboBox.addItem(QtCore.QString())
        self.trig1_edgeComboBox.addItem(QtCore.QString())
        ...
        self.trig1_levelSpinBox.setProperty("value", QtCore.QVariant(1.0))
        self.trig1_levelSpinBox.setObjectName("trig1_levelSpinBox")
        ...
        self.trigCouplingComboBox.setObjectName("trigCouplingComboBox")
        self.trigCouplingComboBox.addItem(QtCore.QString())
        self.trigCouplingComboBox.addItem(QtCore.QString())
        ...
        self.trig2_sourceComboBox.setObjectName("trig2_sourceComboBox")
        self.trig2_sourceComboBox.addItem(QtCore.QString())
        self.trig2_sourceComboBox.addItem(QtCore.QString())
        self.trig2_sourceComboBox.addItem(QtCore.QString())
        self.trig2_sourceComboBox.addItem(QtCore.QString())
        ...
        self.trig2_edgeComboBox.setObjectName("trig2_edgeComboBox")
        self.trig2_edgeComboBox.addItem(QtCore.QString())
        self.trig2_edgeComboBox.addItem(QtCore.QString())
        ...
        self.trig2_levelSpinBox.setProperty("value", QtCore.QVariant(1.0))
        self.trig2_levelSpinBox.setObjectName("trig2_levelSpinBox")
        ...
        self.trigOpComboBox.setObjectName("trigOpComboBox")
        self.trigOpComboBox.addItem(QtCore.QString())
        self.trigOpComboBox.addItem(QtCore.QString())
        self.trigOpComboBox.addItem(QtCore.QString())
        self.trigOpComboBox.addItem(QtCore.QString())
        ...
        self.datapathButton.setObjectName("datapathButton")
        ...
        self.x_autoscaleCheckBox.setObjectName("x_autoscaleCheckBox")
        ...
        self.y_autoscaleCheckBox.setObjectName("y_autoscaleCheckBox")
